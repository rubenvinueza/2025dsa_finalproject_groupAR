...
author: "Aytan Pirverdiyeva 1 & FULL NAME STUDENT 2"
format:
  html:
    code-fold: false
...
Nine samples were evaluated per treatment combination, with a mixed model used to determine significant differences using ANOVA.
